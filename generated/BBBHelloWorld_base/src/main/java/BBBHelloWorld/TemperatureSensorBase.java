...
public class TemperatureSensorBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public TemperatureSensorBase( String federation_id, String federate_id ) throws Exception {
        ...
        SensorMessage.publish( getRTI() );
        		
		// object pubsub
                        }
        
       // constructor
	public TemperatureSensorBase(  String[] federationInfo ) throws Exception {
		...
		if(federationInfo.length  > 2) {
			...
			SensorMessage.enablePublishLog(
				"SensorMessage",
				"TemperatureSensor",
				"NORMAL",
				loglevel);
	...
	public SensorMessage create_SensorMessage() {
	   SensorMessage interaction = new SensorMessage();
