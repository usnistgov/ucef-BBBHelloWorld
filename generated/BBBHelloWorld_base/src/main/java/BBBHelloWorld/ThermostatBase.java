...
public class ThermostatBase extends SynchronizedFederate {
	...
	// constructor
	public ThermostatBase( String federation_id, String federate_id ) throws Exception {
        ...
        ControlMessage.publish( getRTI() );
        
        SensorMessage.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			SensorMessage.get_handle(), 
       ...
       // constructor
	public ThermostatBase(  String[] federationInfo ) throws Exception {
		...
		if(federationInfo.length  > 2) {
			...
			ControlMessage.enablePublishLog(
				"ControlMessage",
				"Thermostat",
				"NORMAL",
				loglevel);
			
			SensorMessage.enableSubscribeLog(
				"SensorMessage",
				"Thermostat", 
				"NORMAL", 
				loglevel);	
	...
	public ControlMessage create_ControlMessage() {
	   ControlMessage interaction = new ControlMessage();
