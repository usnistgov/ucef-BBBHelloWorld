...
public class HVACBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public HVACBase( String federation_id, String federate_id ) throws Exception {
        ...
        ControlMessage.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			ControlMessage.get_handle(), 
       ...
       // constructor
	public HVACBase(  String[] federationInfo ) throws Exception {
		...
		if(federationInfo.length  > 2) {
			...
			ControlMessage.enableSubscribeLog(
				"ControlMessage",
				"HVAC", 
				"NORMAL", 
				loglevel);	
